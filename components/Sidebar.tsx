    ...
    <div>
      <div className="flex items-center gap-2">
        <Link
          ...
          className="flex w-full items-center gap-2 rounded-md p-2 text-white hover:text-gray-400 focus:text-gray-400 transition-all duration-300 uppercase text-xl font-bold"
        >
          {item.title}
        </Link>
        ...
        {showChildren &&
          item.children.map((item, index) => (
            <Link
              ...
              href={item.href}
              onClick={() => setSheetOpen(false)}
              className="text-white hover:text-gray-400 focus:text-gray-400 transition-all duration-300 uppercase text-xl translate-x-4 flex w-full items-center rounded-md p-2"
            >
              {item.title}
