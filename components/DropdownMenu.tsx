...
export const NavDropDownMenu = ({ item }: { item: NavItemTypes }) => {
  ...
  return (
    <NavigationMenu className="z-20">
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-base p-0 bg-transparent hover:bg-transparent data-[active]:bg-transparent focus-within:text-custom-emerald md:focus-within:text-custom-emerald data-[state=open]:bg-transparent text-white md:hover:text-custom-emerald font-normal h-0">
            {item.title}
          </NavigationMenuTrigger>
          <NavigationMenuContent>
